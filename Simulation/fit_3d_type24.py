...
save_data_path = 'E:/02_AIS/Simulation/AIS/190708/fit_v2/data/3d_type_24/'
save_figure_path = 'E:/02_AIS/Simulation/AIS/190708/fit_v2/figure/3d_type_24/'
...
for p in range(7):
	...
	for i,d in enumerate(dist_x):
		for j,l in enumerate(len_x):	
			...
			for sec in h.allsec():
				print(sec)	
	with open(save_data_path+'type2_map4'\
			   +'_aina12_'+str(aina12_x[p])\
			   +'_aina16_'+str(aina16_x[p])\
			   +'_aik_'+str(aik_x[p])\
			   +'_bpv.p', 'wb') as file:
