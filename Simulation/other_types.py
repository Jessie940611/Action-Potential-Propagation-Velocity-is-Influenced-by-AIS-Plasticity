...
def plotHeatmap(data, flag):
	...
	cmap = plt.cm.jet
	if flag == 'bpAP':
		norm = matplotlib.colors.Normalize(vmin=20, vmax=90)  
	else:
...
#	plot3d(fw,'darkgray','fAP','Type 1 fAP')
	...
	na_type = [9,5,6]
	for nt in na_type:
		file_path = 'E:/02_AIS/Simulation/AIS/190708/fit_v2/data/3d_type_'+str(nt)+'/'
